 ...
 ***************************************************************************
 *** 2.0.2 ************************************************** 17/12/2006 ***
 * -Added French language (thanks to EZEki3l)                              *
 *** 2.0.1 ************************************************** 15/09/2005 ***
...
void my_add_languages(void)
{
	...
	char *langtable_fr[] = {
		/* LANG_NO_PASSWORD */
		"Vous devez entrer un mot de passe pour activer le Superadmin sur\n"
		"ce réseau. Veuillez l'ajouter apres la commande SET SUPERADMIN\n"
		"Par exemple: \002/os SET SUPERADMIN ON MotDePasse\002.",
		/* LANG_INVALID_PASSWORD */
