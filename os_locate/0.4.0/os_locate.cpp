 ...
 *
 *  - The GeoIP Database is not UTF8 formatted. So its at this time not possible to enter searchstrings
 *    which include special chars (like öäüß).
 *
 *  Both Issues planned to be fixed in a future release, but not nessesary the next one ;-)
 *
 *
 *  Changes:
 * ==========
