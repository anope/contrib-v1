...
* ------------------------------------------------------------
* Changes:
* 1.0.2 - 27/-8/09 - Removed unnecessary pointers in functions
                     and fixed a memleak - ta Duke :)
* 1.0.1 - 26/08/09 - Re-Added optional Configuration Directive
*         to require Roots to use password too.
* 1.0.0 - First Release
*/
