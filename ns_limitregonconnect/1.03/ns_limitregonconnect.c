 ...
 * Author: djGrrr <djgrrr+ns_limitregonconnect@p2p-network.net> +
 *         SGR <Alex_SGR@ntlworld.com>
 * Date: 2006/10/05 (Last update: 2006/12/14)
 * -----------------------------------------------------------
 ...
 *
 *  1.02 - Fixed memory leak on MODUNLOAD (thanks to Tom65789
 *         for pointing it out)
 *
 *  1.03 - Fixed windows compiling
 *
 * -----------------------------------------------------------*/
