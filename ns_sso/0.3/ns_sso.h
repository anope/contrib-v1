...
#define LNG_CHANGE_EMAIL_AT_SITE	1
#define LNG_SIGN_UP_AT_SITE			2
#define LNG_DROP_AT_SITE			3
#define LNG_TICKETIDENTIFY_SYNTAX	4
#define LNG_CHANGING_YOUR_NICK		5
#define LNG_TAKEN_OWNERSHIP_OF_NICK	6
#define LNG_DROPPED_YOUR_NICK		7

#define LNG_NO_CONSTANTS			7
