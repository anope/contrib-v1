...
#  Author    : mark
#  Date      : 03/11/2008
#  Modified  : 02/08/2011 Phil <phil@anope.org>
#  Version   : 1.0.2
...
#define LANG_MIGRATE_SYNTAX		0
#define LANG_MIGRATE_SYNTAX_EX	1
#define LANG_MIGRATE_SUCCESS	2
...
int do_migrate(User *u)
{
	...
	alog("cs_migrate: %s!%s@%s has migrated %s to %s", u->nick, u->username, u->host, source->name, dest->name);
