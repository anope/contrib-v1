 ...
 * Version : 1.0
 * Date    : (Created) August 7th, 2010 (Last modified) August 7th, 2010
 * ----------------------------------------------------------------------------
...
static const char *const VERSION = "v1.0";
...
{
	char oldTrigger = *BSFantasyCharacter;

	/* This is to set the current module as the module name is the previous module when this is called */
