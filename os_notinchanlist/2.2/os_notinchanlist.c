 ...
 * Date: 05/08/2006  (Last update: 31/08/2007)
 * Version: 2.2
 * -----------------------------------------------------------------------------
...
void add_languages(void) {
	char *langtable_en_us[] = {
		...
		" in the scan will be banned simultaniously.\n"
		...
		" they run the risk of being AKILLed or SHUNed. This also applies to any \n"
		" opers who are using a shared IP address etc.",
	...
	char *langtable_nl[] = {
		...
		" bestand, zullen allle gedetecteerde gebruikers tegelijkertijd verbannen worden\n"
		...
		" het risiko ge-AKILLed of ge-SHUNed te worden. Dit geldt ook voor alle opers die \n"
		" een gedeeld IP adress gebruiken.",
		/* LANG_NOTINCHANLIST_NOTICE */
