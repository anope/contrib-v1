 ...
 * Date: 05/08/2006  (Last update: 08/10/2006)
 * Version: 2.1b +S
 * -----------------------------------------------------------------------------
 * Limitations: This Version has been made SOLELY for UnrealIRCd !!!
 * Tested: Anope-1.7.16 + UnrealIRCd 3.2.3
 * -----------------------------------------------------------------------------
 * This is a spinoff of the regular os_notinchanlist with an extra SHUN
 * argument added on request. This is only available for UnrealIRCd and if
 * you use another ircd, i recommend using the regular version of this module.
 *
 * This module has been tested on Anope-1.7.16, it might work on older
 ...
 * Shun is only supported un UnrealIRCd.
 *
 ...
 *
 * The SHUN argument is only available on UnrealIRCd.
 *
...
#define AUTHOR "Viper"
#define VERSION "2.1b +S"


/* Language defines */
#define LANG_NUM_STRINGS 					20
...
void add_languages(void) {
	char *langtable_en_us[] = {
		...
		" Syntax: NOTINCHANLIST [NOTICE | KILL | AKILL | JOIN | SHUN] [QUIET] [NOTID]",
		...
		" \n"
		" QUIET can only be specifed if NOTICE, KILL, AKILL, JOIN or SHUN \n"
		" has been specified."
		...
		" SHUN is only supported on UnrealIRCd.\n"
		" \n"
	...
	char *langtable_nl[] = {
		...
		/* LANG_NOTINCHAN_SYNTAX */
		" Gebruik: NOTINCHANLIST [NOTICE | KILL | AKILL | JOIN | SHUN] [QUIET] [NOTID]",
		/* LANG_NOTINCHAN_SYNTAX_EXT */
		" Gebruik: NOTINCHANLIST [NOTICE | KILL | AKILL | JOIN | SHUN] [QUIET] [NOTID]\n"
		" \n"
		...
		" \n"
		" Als de SHUN optie wordt gebruikt, zulle de gevonden gebruikersthe users' shunned worden \n"
		" voor OSNotInChanAkillTime tijd. SHUN is alleen ondersteund op UnrealIRCd.\n"
		" \n"
