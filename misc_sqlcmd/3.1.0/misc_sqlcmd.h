...
struct _sqlcmd_command {
	char *name;
	int params;
	int (*handle)(int ac, char **av, char *pass);
	SQLCmd *prev;
	SQLCmd *next;
};
...
E int sqlcmd_handle_ping(int ac, char **av, char *pass);
...
E char *sqlcmd_checksum(char *cmd, char *param_str, char *pass, unsigned long pass_len, char *ts);
...
E char *sqlcmd_mysql_quote(char *unquoted, int size);
E void sql_del_cs_info(char *chan);

/* Functions - Obj */
E int sqlcmd_create(char *name, int params, int (*handle)(int ac, char **av, char *pass));
E SQLCmd *sqlcmd_find(char *name);
E int sqlcmd_status_update(int id, int status);

/* Functions - NickServ */
E int sqlcmd_handle_nickreq(int ac, char **av, char *pass);
E int sqlcmd_handle_nickreg(int ac, char **av, char *pass);
E int sqlcmd_handle_nickconf(int ac, char **av, char *pass);
E int sqlcmd_handle_nickgroup(int ac, char **av, char *pass);
E int sqlcmd_handle_nickdrop(int ac, char **av, char *pass);

/* Functions - ChanServ */
E int sqlcmd_handle_chanreg(int ac, char **av, char *pass);
E int sqlcmd_handle_chanaddsop(int ac, char **av, char *pass);
E int sqlcmd_handle_chanaddaop(int ac, char **av, char *pass);
E int sqlcmd_handle_chanaddhop(int ac, char **av, char *pass);
E int sqlcmd_handle_chanaddvop(int ac, char **av, char *pass);
E int sqlcmd_handle_addxop(int ac, char **av, int lvl);
E int sqlcmd_handle_chanaddaccess(int ac, char **av, char *pass);
E int sqlcmd_handle_chandelaccess(int ac, char **av, char *pass);
...
E int sqlcmd_handle_chantopic(int ac, char **av, char *pass);
E int sqlcmd_handle_chandrop(int ac, char **av, char *pass);

/* Functions - BotServ */
E int sqlcmd_handle_botassign(int ac, char **av, char *pass);
E int sqlcmd_handle_botsay(int ac, char **av, char *pass);
E int sqlcmd_handle_botact(int ac, char **av, char *pass);
E int sqlcmd_handle_botunassign(int ac, char **av, char *pass);

/* Functions - MemoServ */
E int sqlcmd_handle_memosend(int ac, char **av, char *pass);
E int sqlcmd_handle_memodel(int ac, char **av, char *pass);
int del_memo_callback(User * u, int num, va_list args);
E int sqlcmd_handle_memoclear(int ac, char **av, char *pass);
