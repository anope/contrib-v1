 ...
 **/
int sqlcmd_handle_chanreg(int ac, char **av, char *pass) {
	NickAlias *na;
	NickCore *nc;
	Channel *c;
	ChannelInfo *ci;
	...
	if (readonly) 
	...
	else if (!nick_is_services_admin(nc) && nc->channelmax > 0 && nc->channelcount >= nc->channelmax)
		...
		ci->founder = nc;
		memcpy(ci->founderpass, pass, PASSMAX);
 ...
 **/
int sqlcmd_handle_chanaddsop(int ac, char **av, char *pass) {
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chanaddaop(int ac, char **av, char *pass) {
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chanaddhop(int ac, char **av, char *pass) {
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chanaddvop(int ac, char **av, char *pass) {
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chanaddaccess(int ac, char **av, char *pass) {
	ChannelInfo *ci = NULL;
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chandelaccess(int ac, char **av, char *pass) {
	ChannelInfo *ci = NULL;
...
int sqlcmd_do_access_add(ChannelInfo *ci, char *target, int lvl, char *by) {
	...
	if (lvl == 0)
		return SQLCMD_ERROR_CHAN_ACC_LVL_NONZERO;
	else if (lvl <= ACCESS_INVALID || lvl >= ACCESS_FOUNDER)
		return SQLCMD_ERROR_CHAN_ACC_LVL_RANGE;
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chantopic(int ac, char **av, char *pass) {
	Channel *c;
	ChannelInfo *ci;
 ...
 * @param pass Password hash. [NOT USED]
 **/
int sqlcmd_handle_chandrop(int ac, char **av, char *pass) {
