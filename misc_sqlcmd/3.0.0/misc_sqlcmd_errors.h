...
#define SQLCMD_ERROR_NICK_ALREADY_REGISTERED	-21
#define SQLCMD_ERROR_NICK_FORBIDDEN				-22
#define SQLCMD_ERROR_NICK_SUSPENDED				-23
#define SQLCMD_ERROR_NICK_CANNOT_BE_REGISTERED  -24
#define SQLCMD_ERROR_NICK_IN_USE				-25
#define SQLCMD_ERROR_EMAIL_INVALID				-26
#define SQLCMD_ERROR_NICK_CONF_NOT_FOUND		-27
#define SQLCMD_ERROR_NICK_CONF_INVALID			-28
#define SQLCMD_ERROR_NICK_REG_FAILED			-29
#define SQLCMD_ERROR_NICK_GROUP_CHANGE_DISABLED	-30
#define SQLCMD_ERROR_NICK_GROUP_SAME			-31
#define SQLCMD_ERROR_NICK_GROUP_TOO_MANY		-32
...
#define SQLCMD_ERROR_NO_MEMOS					-80
#define SQLCMD_ERROR_MEMO_DOES_NOT_EXIST		-81
#define SQLCMD_ERROR_MEMO_DELETED_NONE			-82
