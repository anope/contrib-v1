/**
 * Methods that fill the Modules' language table. - Source
 *
 ***********
 ...
 * --------------------------
 *
 * English language: Viper <Viper@Absurd-IRC.net>
 *
 *
...
void add_languages(void) {
	char *langtable_en_us[] = {
		...
		/* LANG_MINFO */
		"SYNTAX: \002%sminfo\002 or \002%smodinfo\002\n"
		...
		/* LANG_MUTE_SYNTAX */
		"SYNTAX: %smute [nick|mask] (IRCd Depend)",
		/* LANG_MUTE_SYNTAX_EXT */
		"SYNTAX: \002%smute\002 [nick|mask]\n"
		"Bans or mutes the given nickname or usermask from the channel. (IRCd Depend)",
		/* LANG_UNMUTE_SYNTAX */
		"SYNTAX: %sunmute [nick|mask] (IRCd Depend)",
		/* LANG_UNMUTE_SYNTAX_EXT */
		"SYNTAX: \002%sunmute\002 [nick|mask]\n"
		"Unbans or unmutes the given nickname or usermask from the channel. (IRCd Depend)",
		/* LANG_SVERSION */
		...
		"   %smodinfo   -   Shows info about this module\n"
		...
		"   %sban       -   Bans the user from the channel without kicking him\n"
		"   %sunban     -   Removes the ban on a user.\n"
		"   %smute      -   Mutes / Bans the user (IRCd Depend)\n"
		"   %sunmute    -   Unmutes / unbans the user (IRCd Depend)\n"
		...
		"  %shelp access   - Shows commands to manipulate channel access list(s).\n"
