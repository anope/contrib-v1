 ...
 *************************************************
 * Module used in: nickserv/fidentify
  ...
  public:
	...
	void Execute(CommandSource &source, const std::vector<Anope::string> &params)
	{
	  ...
	  if(!na || !ana){
	    ...
	    { 
	      Log(LOG_OVERRIDE, u, this, NULL) << "to force identify " << u->nick << " to user account \"" << na->nc->display << "\"";			
	...
	{ 
	  ...
	  source.Reply(" ");
	  source.Reply(_("Forcefully identifies a user to their nickname or to a specified account."));
	  return true;
	}
};
...
class NSFidentify : public Module
{
 ...
 public:
		...
		commandnsfidentify(this)
	{
		...
		ModuleManager::RegisterService(&commandnsfidentify); //adds our commands
	}
};
