 ...
 public:
	...
	CommandReturn Execute(CommandSource &source, const std::vector<Anope::string> &params)
	{
		...
		if (!c || !c->OnHelp(source, ""))
			me->SendMessage(source, _("No help available for \2%s\2"), params[0].c_str());
	...
	{
		me->SendMessage(source, _("Available commands:\n"
			" \n"
			"     HELP                Get help\n"
...
class CommandRestrictedHosts : public Command
{
 ...
 public:
	...
	void OnSyntaxError(CommandSource &source, const Anope::string &)
	{
		me->SendMessage(source, _("Syntax: \2RESTRICTEDHOSTS\2 ADD \2\37host\37\2\n"
