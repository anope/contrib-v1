/***************************************************************************************/
/* Anope Module : ircd_confinfo.c : v2.x                                               */
/* Scott Seufert - katsklaw@msn.com                                                    */
/*                                                                                     */
...
void Module_Help_OPERSERV(User *u)
{
	...
	if(is_services_root(u)) {
		notice(s_OperServ, u->nick, "    IRCDINFO  Lists services ircd info.");
	}
}
...
int Module_Help_OPERSERV_CONFINFO(User *u)
{
        ...
        notice(s_OperServ, u->nick, " Allows Services Administrators to see various config");
        notice(s_OperServ, u->nick, " settings that don't normally have shell access to ");
        notice(s_OperServ, u->nick, " services. ");
	notice(s_OperServ, u->nick, "  ");
...
int Module_Help_NICKSERV_CONFINFO(User *u)
{
        ...
        notice(s_NickServ, u->nick, " Allows users to see various config settings.");
...
int Module_Help_BOTSERV_CONFINFO(User *u)
{
        ...
        notice(s_BotServ, u->nick, " Allows users to see various config settings.");
...
int Module_Help_HOSTSERV_CONFINFO(User *u)
{
        ...
        notice(s_HostServ, u->nick, " Allows users to see various config settings.");
...
int Module_Help_MEMOSERV_CONFINFO(User *u)
{
        ...
        notice(s_MemoServ, u->nick, " Allows users to  see various config settings.");
...
int Module_Help_CHANSERV_CONFINFO(User *u)
{
        ...
        notice(s_ChanServ, u->nick, " Allows users to see various config settings.");
...
int do_botconf (User *u)
{
	...
	int my_bsgentlebwreason = 0;
	int my_bscasesensitive = 0;
	...
	Directive confvalues5[] = {
		{ "BSGentleBWReason", { { PARAM_SET, PARAM_RELOAD, &my_bsgentlebwreason } } }
	};
	Directive confvalues6[] = {
	...
	notice(s_BotServ, u->nick, "Smart join: %s Gentle reason: %s Case sensitive: %s", (my_bssmartjoin ? "Enabled" : "Disabled"), (my_bsgentlebwreason ? "Enabled" : "Disabled"), (my_bscasesensitive ? "Enabled" : "Disabled"));
	notice(s_BotServ, u->nick, "Fantasy character: %s", (my_bsfantasycharacter ? my_bsfantasycharacter : "Disabled"));
