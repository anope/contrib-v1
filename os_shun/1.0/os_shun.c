 ...
 * Date    : 16/09/2007 (Last update: 05/02/2008)
 * Version : 1.0
 * -----------------------------------------------------------------------------
 ...
 *  - add a database backend for SHUN.
 *
 **/
		...
		if ((u2 = finduser(target))) {
			...
			if (!action) {
				send_cmd(NULL, "TKL + s %s %s %s %ld %ld :%s", uname, host, u->nick,
						(long int) time(NULL) + expires, time(NULL), reason);
				moduleNoticeLang(s_OperServ, u, LANG_SHUN_ADDED, uname, u2->host);
				...
				moduleNoticeLang(s_OperServ, u, LANG_SHUN_DELETION, uname, u2->host);
...
void add_languages(void) {
	char *langtable_en_us[] = {
		...
		/* LANG_SHUN_SYNTAX */
		" Syntax: \002SHUN [\037ADD\037 | \037DEL\037] [\037nick\037 | \037mask\037] [+\037expiry\037] [\037reason\037]\002",
		/* LANG_SHUN_SYNTAX_EXT */
		" Syntax: \002SHUN  [\037ADD\037] [\037nick\037 | \037mask\037] [+\037expiry\037] [\037reason\037]\002\n"
	...
	char *langtable_nl[] = {
		...
		/* LANG_SHUN_SYNTAX */
		" Syntax: \002SHUN [\037ADD\037 | \037DEL\037] [\037nick\037 | \037mask\037] [+\037verloop\037] [\037reden\037]\002",
		/* LANG_SHUN_SYNTAX_EXT */
		" Syntax: \002SHUN  [\037ADD\037] [\037nick\037 | \037mask\037] [+\037verloop\037] [\037reden\037]\002\n"
		"         \002SHUN  DEL [\037nick\037 | \037mask\037]\002\n"
		" \n"
		...
		" Indien de reden start met een '+', moet een verlooptijd opgegeven worden!\n"
		" \n"
